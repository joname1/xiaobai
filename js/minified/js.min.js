function linie() {
	...
	var t = e(".preHeader") + e("#top") + e("#graph") + e("#agency") + e("#portfolio") + e("#clients") + e("#contact") + e(".postFooter");
	$(".lines").height(t);
	$(".cloudes").height(t);
	$(".overCloudes").height(t);
...
function lightBox(e, t, n) {
	if (e == "show") {
		$(".lightbox .overPics").attr("data-actual-folder", n);
		$(".lightbox .overPics").attr("data-actual-position", t);
		$.get("/ajax/galery/getNumberOfFiles.php", {
			folder: n
		}, function(e) {
			numberOfElems = parseInt(e);
			var r = (t - 1) % numberOfElems;
			var i = (t + 1) % numberOfElems;
			r = r == 0 ? numberOfElems : r;
			i = i == 0 ? numberOfElems : i;
			$(".lightbox .overPics").removeClass("move");
			$(".lightbox .prevPic .img").css("background-image", 'url("/assets/gallery/big/' + n + "/photo" + r + '.jpg")');
			$(".lightbox .thisPic .img").css("background-image", 'url("/assets/gallery/big/' + n + "/photo" + t + '.jpg")');
			$(".lightbox .nextPic .img").css("background-image", 'url("/assets/gallery/big/' + n + "/photo" + i + '.jpg")');
			$(".lightbox").addClass("sizeUp")
		})
	} else {
		$(".lightbox").removeClass("sizeUp")
	}
}

function lightBoxMove(e) {
	var t = $(".lightbox .overPics").attr("data-actual-folder");
	var n = parseInt($(".lightbox .overPics").attr("data-actual-position"));
	if (e == "left") {
		x = 0 + "%";
		n = (n - 1) % numberOfElems
	} else {
	...
	n = n == 0 ? numberOfElems : n;
	$(".lightbox .overPics").attr("data-actual-position", n);
	$(".lightbox .overPics").addClass("move");
	$(".lightbox .overPics").css({
		"margin-left": x
	});
	setTimeout(function() {
		var e = (n - 1) % numberOfElems;
		var r = (n + 1) % numberOfElems;
		e = e == 0 ? numberOfElems : e;
		r = r == 0 ? numberOfElems : r;
		$(".lightbox .overPics").removeClass("move");
		$(".lightbox .prevPic .img").css("background-image", 'url("/assets/gallery/big/' + t + "/photo" + e + '.jpg")');
		$(".lightbox .thisPic .img").css("background-image", 'url("/assets/gallery/big/' + t + "/photo" + n + '.jpg")');
		$(".lightbox .nextPic .img").css("background-image", 'url("/assets/gallery/big/' + t + "/photo" + r + '.jpg")');
		$(".lightbox .overPics").css({
			"margin-left": "-100%"
		})
	}, 500)
...
function lightBoxInit() {
	$(".lightbox .closeButton").click(function() {
		lightBox("hide", 1, "none")
	});
	$(".lightbox .prevButton").click(function() {
		lightBoxMove("left")
	});
	$(".lightbox .nextButton").click(function() {
		lightBoxMove("right")
	});
...
function getNextDescribe() {
	var e = $(this).attr("data-which");
	$(".logo,.text").removeClass("shown");
	$("." + e).addClass("shown");
	setNextElems(e)
}

function setNextElems(e) {
	var t = "";
	var n = "";
	switch (e) {
		case "creation":
	...
	$(".goLeft").attr("data-which", n);
	$(".goRight").attr("data-which", t)
}

function agencyInit() {
	$(".KerrisSlider .navigator").unbind("click").click(getNextDescribe);
	$(".KerrisSlider .logo").click(getNextDescribe)
}

function getNumAttr(e, t) {
	attr = e.attr(t);
	return parseFloat(attr.replace("px", ""))
}

function getLineSize(e) {
	var t = Math.sqrt(Math.pow(getNumAttr(e, "x1") - getNumAttr(e, "x2"), 2) + Math.pow(getNumAttr(e, "y1") - getNumAttr(e, "y2"), 2));
	e.attr("data-length", t);
	e.css({
...
function hoverAction() {
	function e() {
		$(".graphElems g").removeClass("hovered");
		if ($(this).hasClass("atl")) {
			$(".atlGroup").addClass("hovered")
		} else if ($(this).hasClass("btl")) {
			$(".btlGroup").addClass("hovered")
		} else if ($(this).hasClass("media")) {
			$(".mediaGroup").addClass("hovered")
		} else if ($(this).hasClass("tech")) {
			$(".techGroup").addClass("hovered")
		}
	}
	...
	function t() {
		$(".graphElems g").removeClass("hovered");
		if ($(this).hasClass("atl")) {
			$(".atlGroup").removeClass("hovered")
		} else if ($(this).hasClass("btl")) {
			$(".btlGroup").removeClass("hovered")
		} else if ($(this).hasClass("media")) {
			$(".mediaGroup").removeClass("hovered")
		} else if ($(this).hasClass("tech")) {
			$(".techGroup").removeClass("hovered")
		}
	}

	function n() {
		$(".graphElems g").removeClass("hovered");
		if (GraphX > GraphW / 2 && GraphY <= GraphH / 2) {
			$(".atlGroup").addClass("hovered")
		} else if (GraphX <= GraphW / 2 && GraphY > GraphH / 2) {
			$(".btlGroup").addClass("hovered")
		} else if (GraphX <= GraphW / 2 && GraphY <= GraphH / 2) {
			$(".mediaGroup").addClass("hovered")
		} else if (GraphX > GraphW / 2 && GraphY > GraphH / 2) {
	...
	$(window).mousemove(function(e) {
		GraphX = e.pageX - $("#graphSVG").offset().left;
		GraphY = e.pageY - $("#graphSVG").offset().top;
		GraphH = parseInt($("#graphSVG").height());
		GraphW = parseInt($("#graphSVG").width())
	});
	$("#graph .area").hover(e, t);
	$("#graphSVG").mousemove(n)
}

function graphAnimation() {
	if (!blockAnimation) {
		blockAnimation = true;
		$(".small,.middle,.big").addClass("active");
		var e = $(".bigCircle line.line.outer");
		e = shuffle(e);
		setTimeout(function() {
			$.each($(".centerElem .line.inner"), function(e, t) {
				if (e != 4) {
					$("body").find($(".centerElem .line.inner")[e]).addClass("active")
				} else {
					setTimeout(function() {
						$("body").find($(".centerElem .line.inner")[4]).addClass("active")
					}, 500)
				}
			});
			setTimeout(function() {
				$(".startCircle").addClass("active");
				animateLine(e, 0, e.length, animateLine);
				setTimeout(function() {
					$(".outerLines .line").addClass("active");
					$(".arrows .line").addClass("active");
					$(".outerCircles circle").addClass("active");
					$(".graphElems .line.bold").addClass("active");
					$(".graphElems .line.filler").addClass("active");
					setTimeout(function() {
						$(".outerLines line").addClass("dashed");
						setTimeout(function() {
							$(".graph .area").addClass("active");
							hoverAction()
						}, 250)
					}, 250)
				}, 750)
...
function getFullText(e) {
	$('.textSpace [class^="text_"]').removeClass("show");
	$('.textSpace [class="text_' + e + '"]').addClass("show")
}

function animateGalery() {
	var e = $(this);
	var t = e.data("attributes").folder;
	var n = parseInt(e.data("attributes").which.replace("elem", ""));
	var r = (n - 1).mod(11);
	var s = (n + 1).mod(11);
	$(".galeryImg.left").data("attributes").next = r;
	$(".galeryImg.right").data("attributes").next = s;
	getFullText(t);
	$(".lightbox .overPics").attr("data-actual-folder", t);
	$(".galeryImg.pic1").data("attributes").folder = t;
	$("#pic1 .image").attr("xlink:href", "/assets/gallery/thumb/" + t + "/photo1.jpg");
	$(".galeryImg.pic2").data("attributes").folder = t;
	$("#pic2 .image").attr("xlink:href", "/assets/gallery/thumb/" + t + "/photo2.jpg");
	$(".galeryImg.pic3").data("attributes").folder = t;
	$("#pic3 .image").attr("xlink:href", "/assets/gallery/thumb/" + t + "/photo3.jpg");
	$(".galeryImg.pic4").data("attributes").folder = t;
	$("#pic4 .image").attr("xlink:href", "/assets/gallery/thumb/" + t + "/photo4.jpg");
	var o = e.attr("class");
	var u = o.split(" ");
	$("#" + u[1]).addClass("clicked");
	objectArray.length = 0;
	for (i = 0; i < 11; i++) {
		objectArray.push(".pattern" + i)
	}
	objectArray = shuffle(objectArray);
	$.each(objectArray, function(e, t) {
		setTimeout(function() {
			if (!$(t).hasClass("clicked")) {
				$("." + $(t).data("attributes").which).removeClass("show");
				$(t).removeClass("show");
				$("." + $(t).data("attributes").which).show();
				setTimeout(function() {
					$(t).hide();
					$("." + $(t).data("attributes").which).addClass("show")
				}, 500)
			}
		}, e * 50)
	});
	setTimeout(function() {
		$("#" + u[1]).removeClass("show");
		$("#" + u[1]).removeClass("clicked");
		$("." + e.data("attributes").which).show();
		$(".textSpace").addClass("show")
	}, 550)
}

function reverseGalery() {
	$(".textSpace").removeClass("show");
	objectArray.length = 0;
	for (i = 0; i < 11; i++) {
		objectArray.push(".elem" + i)
	}
	objectArray = shuffle(objectArray);
	$.each(objectArray, function(e, t) {
		setTimeout(function() {
...
function getNextProject(e) {
	var t = $(".galeryImg.pattern" + e).data("attributes").folder;
	var n = (parseInt(e) - 1).mod(11);
	var r = (parseInt(e) + 1).mod(11);
	$(".galeryImg.left").data("attributes").next = n;
	$(".galeryImg.right").data("attributes").next = r;
	getFullText(t);
	$(".lightbox .overPics").attr("data-actual-folder", t);
	$(".galeryImg.pic1").data("attributes").folder = t;
	$("#pic1 .image").attr("xlink:href", "/assets/gallery/thumb/" + t + "/photo1.jpg");
...
function getNextElem() {
	var e = $(this).data("attributes").next;
	$(".textSpace").removeClass("show");
	...
	setTimeout(function() {
		$(".pic3").removeClass("show")
	}, 150);
	setTimeout(function() {
		$(".pic4").removeClass("show")
	}, 200);
	setTimeout(function() {
		getNextProject(e)
	}, 750);
...
function portfolioSquaresHover() {
	function e() {
		var e = $(this).attr("class");
		var t = e.split(" ");
		$("#" + t[1] + " .colourFill").addClass("grow");
		$("#" + t[1] + " .image").addClass("sizeUp");
		$("#" + t[1] + " .circle.moved").addClass("reduce");
		$("#" + t[1] + " .plus.moved").addClass("reduce");
		$("#" + t[1] + " .circle.goRound").addClass("round");
		if ($(this).hasClass("all")) {
			for (i = 0; i < 11; i++) {
				$("#pattern" + i + " .portfolioText.up").attr("y", parseFloat($("#pattern" + i + " .portfolioText.up").data("attributes").yOut));
				$("#pattern" + i + " .portfolioText.down").attr("y", parseFloat($("#pattern" + i + " .portfolioText.down").data("attributes").yOut))
			}
			animateTextPosition($("#" + t[1] + " .portfolioText.up"), "y", 50, $("#" + t[1] + " .portfolioText.up").data("attributes").yIn);
			animateTextPosition($("#" + t[1] + " .portfolioText.down"), "y", 50, $("#" + t[1] + " .portfolioText.down").data("attributes").yIn)
		}
	}
	...
	function t() {
		var e = $(this).attr("class");
		var t = e.split(" ");
		var n = parseInt(t[1].replace("pattern", ""));
		stopAnimate = true;
		if ($(this).hasClass("all")) {
			for (i = 0; i < 11; i++) {
				if (i !== n) {
			...
			animateTextPosition($("#" + t[1] + " .portfolioText.up"), "y", 50, $("#" + t[1] + " .portfolioText.up").data("attributes").yOut);
			animateTextPosition($("#" + t[1] + " .portfolioText.down"), "y", 50, $("#" + t[1] + " .portfolioText.down").data("attributes").yOut)
		}
		$("#" + t[1] + " .colourFill").removeClass("grow");
		$("#" + t[1] + " .image").removeClass("sizeUp");
		$("#" + t[1] + " .circle.moved").removeClass("reduce");
		$("#" + t[1] + " .plus.moved").removeClass("reduce");
		$("#" + t[1] + " .circle.goRound").removeClass("round")
	}
	$(".no_mobile .galeryImg").unbind("hover").hover(e, t)
}

function animateTextPosition(e, t, n, r) {
	if (stopAnimate == true) {
	...
	var s = new Array(3.2, 9.6, 16, 22.4, 28.8, 35.2, 41.6, 48, 54.4, 60.8, 67.2, 73.6, 80, 86.4, 92.8, 99.2, 105.6, 112, 118.4, 124.8, 131.2, 137.6, 144, 150.4, 156.8);
	var o = parseFloat(e.attr(t));
	var u = 0;
	if (o > r) {
...
function drawSquares(e) {
	$("#" + e + " .svgContainer.no_mobile").addClass("active");
	$(".svgContainer.no_mobile .dashed." + e).addClass("startAnimation");
	setTimeout(function() {
		$(".svgContainer.no_mobile ." + e + ".tofadein").addClass("action");
		$(".svgContainer.no_mobile .dashed." + e + ".tofadeout").addClass("action");
		if (e == "clients") {
			$(".svgContainer.no_mobile .logotype.strict").css("opacity", "1");
			clientsSquaresHover()
		}
		if (e == "portfolio") {
			$(".no_mobile .galeryImg").addClass("show");
			portfolioSquaresHover();
			$(".no_mobile .galeryImg.all").unbind("click").click(animateGalery);
			$(".no_mobile .galeryImg.close").unbind("click").click(reverseGalery);
			$(".no_mobile .galeryImg.left").unbind("click").click(getNextElem);
			$(".no_mobile .galeryImg.right").unbind("click").click(getNextElem);
			$(".no_mobile .galeryImg.pic1").unbind("click").click(function() {
				lightBox("show", 1, $(this).data("attributes").folder)
			});
			$(".no_mobile .galeryImg.pic2").unbind("click").click(function() {
				lightBox("show", 2, $(this).data("attributes").folder)
			});
			$(".no_mobile .galeryImg.pic3").unbind("click").click(function() {
				lightBox("show", 3, $(this).data("attributes").folder)
			});
			$(".no_mobile .galeryImg.pic4").unbind("click").click(function() {
				lightBox("show", 4, $(this).data("attributes").folder)
			})
		}
	}, 1500)
}

function clientsSquaresHover() {
	function e() {
		var e = $(this).attr("class");
		var t = e.split(" ");
		$("." + t[2] + ".strict").css("opacity", "0");
		$("." + t[2] + ".alternate").css("opacity", "1")
	}

	function t() {
		var e = $(this).attr("class");
		var t = e.split(" ");
		$("." + t[2] + ".strict").css("opacity", "1");
		$("." + t[2] + ".alternate").css("opacity", "0")
	}
	$(".logotype").unbind("hover").hover(e, t)
}

function mobilePortfolio(e) {
	$("#portfolioSquareMobile .dashed").hide();
	var t = $(".portfolioMobileText .text.active").index();
	var n = t;
	var r = 0;
	var i = 0;
	var s = 0;
	var o = 0;
	$(".portfolioMobileText .text").removeClass("active");
	var u = $(".portfolioMobileText .text").length - 1;
	if (e) {
		r = t - 3;
		i = t - 2;
		n = t - 1;
	...
	var a = $("#portfolioSquareMobile .pattern0");
	var f = $("#portfolioSquareMobile .pattern1");
	var l = $("#portfolioSquareMobile .pattern2");
	var c = $("#portfolioSquareMobile .pattern3");
	var h = $("#portfolioSquareMobile .pattern4");
	a.removeClass("show");
	setTimeout(function() {
		f.removeClass("show")
	}, 100);
	...
	setTimeout(function() {
		a.attr("fill", "url(#pattern" + r + "_mobile)");
		f.attr("fill", "url(#pattern" + i + "_mobile)");
		l.attr("fill", "url(#pattern" + n + "_mobile_big)");
		c.attr("fill", "url(#pattern" + s + "_mobile)");
		h.attr("fill", "url(#pattern" + o + "_mobile)");
		setTimeout(function() {
			a.addClass("show");
			setTimeout(function() {
				f.addClass("show")
	...
	$($(".portfolioMobileText .text")[n]).addClass("active")
}

function triggerMobilePortfolio() {
	$(".mobilePortfolioDescribe .navigator").click(function() {
		mobilePortfolio($(this).hasClass("goLeft"))
	})
}

function animateScroll(e, t, n) {
	if (typeof e == "object") {
		var r = $(this).attr("href");
		if ($(this).parent().hasClass("elemAlign")) {
			var i = "#top"
		} else {
	...
	$(".menu ul li .divFill").removeClass("active");
	$('.menu a[href="' + e + '"]').find(".divFill").addClass("active");
	if (i == "#top" && r != "#top") {
	...
	var u = o["top"];
	var a = u;
	var f = $(".section" + i).index();
	var l = $(".section" + r).index();
	var c = 0;
	if (typeof n === "undefined") {
		c = (Math.max(f, l) - Math.min(f, l)) * 500 + 500
	} else {
		c = n
	}
	wait = true;
...
function menuNavig() {
	var e = location.hash == "" ? "#top" : location.hash;
	var t = $(this).attr("href");
	var n = isMacBook() ? 630 : 640;
	if ($(window).innerHeight() > n && $(window).innerWidth() > 1023 || isiPhone()) {
		animateScroll(t, e)
	} else {
		normalScroll(t)
	}
...
function arrowsScroll() {
	var e = isMacBook() ? 630 : 640;
	$(document).bind("keydown", function(t) {
		if ($(window).innerHeight() > e && $(window).innerWidth() > 1023) {
			if (!wait) {
				var n = location.hash == "" ? "#top" : location.hash;
				var r = $(".section" + n).index();
				if (t.which == 38) {
					if (n != "#top") {
						var i = "#" + $("body").find($(".section")[r - 2]).attr("id");
						if ($(window).innerHeight() > e && $(window).innerWidth() > 1023 || isiPhone()) {
							animateScroll(i, n)
						} else {
							normalScroll(i)
						}
				...
				if (t.which == 40) {
					if (n != "#contact") {
						var i = "#" + $("body").find($(".section")[r]).attr("id");
						if ($(window).innerHeight() > e && $(window).innerWidth() > 1023 || isiPhone()) {
							animateScroll(i, n)
						} else {
							normalScroll(i)
			...
			var s = getPositionFromScroll();
			$(".menu ul li .divFill").removeClass("active");
			$('.menu a[href="' + s + '"]').find(".divFill").addClass("active");
			$(".menu").removeClass("goLeft");
			switch (s) {
				case "#clients":
					drawSquares("clients");
...
function preventNormalScroll() {
	var e = isMacBook() ? 630 : 640;
	$("body").bind("mousewheel", function(t, n) {
		if ($(window).innerHeight() > e && $(window).innerWidth() > 1023) {
			if (!wait) {
				var r = location.hash == "" ? "#top" : location.hash;
				var i = $(".section" + r).index();
				if (n > 0) {
					if (r != "#top") {
						var s = "#" + $("body").find($(".section")[i - 2]).attr("id");
						if ($(window).innerHeight() > e && $(window).innerWidth() > 1023 || isiPhone()) {
							animateScroll(s, r)
						} else {
							normalScroll(s)
					...
					if (r != "#contact") {
						var s = "#" + $("body").find($(".section")[i]).attr("id");
						if ($(window).innerHeight() > e && $(window).innerWidth() > 1023 || isiPhone()) {
							animateScroll(s, r)
						} else {
							normalScroll(s)
...
function getPositionFromScroll() {
	var e = f = 0;
	var t = parseInt($("#top").height());
	var n = e + t;
	var r = parseInt($("#graph").height());
	var i = e + t + r;
	var s = parseInt($("#agency").height());
	var o = e + t + r + s;
	var u = parseInt($("#portfolio").height());
	var a = e + t + r + s + u;
	var l = parseInt($("#clients").height());
	var c = e + t + r + s + u + l;
	var h = parseInt($("#contact").height());
	var p = e + t + r + s + u + l + h + f;
	var d = parseInt($("body").scrollTop());
	var v = "#top";
	if (d >= 0 && d < n) {
		v = "#top"
	} else if (d >= n && d < i) {
...
function fixPositionOnResize() {
	function r() {
		var i = isMacBook() ? 630 : 640;
		if (new Date - e < n) {
			setTimeout(r, n)
		} else {
			t = false;
			var s = location.hash == "" ? "#top" : location.hash;
			var o = getPositionFromScroll();
			if ($(window).innerHeight() > i && $(window).innerWidth() > 1023 || isiPhone()) {
				animateScroll(s, o)
			} else {
				normalScroll(s)
			}
...
function showMenu() {
	$(".menuButton").click(function() {
		if ($(this).hasClass("opened")) {
			...
			$(".menuIcon").addClass("shown");
			$(".menu").removeClass("active");
			$(".xIcon").removeClass("shown")
		} else {
			$(this).addClass("opened");
			$(".menuIcon").removeClass("shown");
			$(".menu").addClass("active");
			$(".xIcon").addClass("shown")
		}
	});
	$(".divFill").click(function() {
...
function radio() {
	$(".radio").click(function() {
		$(".radio").find($("img")).attr("src", "assets/checkbox_a.png");
		$(this).find($("img")).attr("src", "assets/checkbox_b.png")
	})
}
...
function startAnimations() {
	setTimeout(function() {
		if (location.hash) {
			...
			setTimeout(function() {
				animateScroll(location.hash, "#top")
			}, 500)
		} else {
			animateScroll("#top", "#top", 0)
		}
	}, 1);
	$(".menu a").click(menuNavig);
	$(window).load(function() {
		$("body").addClass("startAnim")
	});
	$(".animateScroll").click(animateScroll)
}

function areaChanger() {
	$("#graph .navigator").click(function() {
		var e = $('.area[data-elem="' + $(this).attr("data-which") + '"]').index();
		var t = "";
		var n = "";
		var r = $(this).hasClass("goLeft");
		switch (e) {
			case 2:
				t = "techGroup";
				n = "atlGroup";
		...
		if (r) {
			$('.area[data-elem="' + n + '"]').hide()
		} else {
			$('.area[data-elem="' + t + '"]').hide()
		}
		$('.area[data-elem="' + $(this).attr("data-which") + '"]').show();
		$("#graph .navigator.goLeft").attr("data-which", t);
		$("#graph .navigator.goRight").attr("data-which", n)
	})
}
...
function svgLoad() {
	...
	$("svg *").each(function() {
		...
		if (onload) {
			onload = onload.split("$(this)").join("s");
			onload = "function doFFload(s){" + onload + "}";
			eval(onload);
			doFFload($(this))
		}
	})
	...
	$("#contact .send").click(function() {
		$.ajax({
			...
			data: {
				...
				firm: $('#contact input[name="firm"]').val(),
				area: $('#contact input[name="area"]:checked').val(),
			...
			success: function(e) {
				...
				if (t.name == 0) {
					$('#contact input[name="name"]').css("border-color", "#f00")
				} else {
					$('#contact input[name="name"]').css("border-color", "#8b8b8b")
				}
				if (t.mail == 0) {
					$('#contact input[name="mail"]').css("border-color", "#f00")
				} else {
					$('#contact input[name="mail"]').css("border-color", "#8b8b8b")
				}
				if (t.message == 0) {
					$('#contact textarea[name="message"]').css("border-color", "#f00")
				} else {
					$('#contact textarea[name="message"]').css("border-color", "#8b8b8b")
				}
				if (t.wiad == 0) {
					$(".contactMessage.pl").text("Popraw błędne pola");
					$(".contactMessage.en").text("Correct wrong fields")
				} else {
					ga("send", "pageview", "/dziekujemy.html");
					$(".contactMessage.pl").text("Wiadomość wysłano");
					$(".contactMessage.en").text("Message sent")
				}
			}
		});
		return false
...
function init() {
	...
	if (isMacBook()) {
		$("html").removeClass("no_macbook");
		$("html").addClass("macbook")
	}
	$(".portfolioText").load();
	triggerMobilePortfolio()
}(function(e) {
...
(function(e) {
	function t() {
		...
		this._renesis = n("RenesisX.RenesisCtrl")
	}

	function n(e) {
		try {
			return !!(window.ActiveXObject && new ActiveXObject(e))
		} catch (t) {
			return false
		}
	}
	...
	function i(t, n) {
		this._svg = t;
		this._container = n;
		for (var r = 0; r < e.svg._extensions.length; r++) {
			var i = e.svg._extensions[r];
	...
	e.extend(t.prototype, {
		...
		_attachSVG: function(t, n) {
			var r = t.namespaceURI == this.svgNS ? t : null;
			var t = r ? null : t;
			if (e(t || r).hasClass(this.markerClassName)) {
				return
			}
			if (typeof n == "string") {
				n = {
			...
			e(t || r).addClass(this.markerClassName);
			try {
				if (!r) {
					r = document.createElementNS(this.svgNS, "svg");
					r.setAttribute("version", "1.1");
					if (t.clientWidth > 0) {
						r.setAttribute("width", t.clientWidth)
					}
					if (t.clientHeight > 0) {
						r.setAttribute("height", t.clientHeight)
					}
					t.appendChild(r)
				}
				this._afterLoad(t, r, n || {})
			} catch (i) {
				if (e.browser.msie) {
					if (!t.id) {
						t.id = "svg" + this._uuid++
					}
					this._settings[t.id] = n;
					t.innerHTML = '<embed type="image/svg+xml" width="100%" ' + 'height="100%" src="' + (n.initPath || "") + 'blank.svg" ' + 'pluginspage="http://www.adobe.com/svg/viewer/install/main.html"/>'
				} else {
					t.innerHTML = '<p class="svg_error">' + this.local.notSupportedText + "</p>"
				}
			}
		},
		_registerSVG: function() {
			for (var t = 0; t < document.embeds.length; t++) {
				var n = document.embeds[t].parentNode;
				if (!e(n).hasClass(e.svg.markerClassName) || e.data(n, r)) {
					continue
				}
				var i = null;
				try {
					i = document.embeds[t].getSVGDocument()
				} catch (s) {
					setTimeout(e.svg._registerSVG, 250);
					return
				}
				i = i ? i.documentElement : null;
				if (i) {
					e.svg._afterLoad(n, i)
				}
			}
		},
		_afterLoad: function(t, n, i) {
			var i = i || this._settings[t.id];
			this._settings[t ? t.id : ""] = null;
			var s = new this._wrapperClass(n, t);
			e.data(t || n, r, s);
			try {
				if (i.loadURL) {
					s.load(i.loadURL, i)
				...
				if (i.settings) {
					s.configure(i.settings)
				}
				if (i.onLoad && !i.loadURL) {
					i.onLoad.apply(t || n, [s])
				}
			} catch (o) {
				alert(o)
			}
		...
		_getSVG: function(t) {
			t = typeof t == "string" ? e(t)[0] : t.jquery ? t[0] : t;
			return e.data(t, r)
		},
		_destroySVG: function(t) {
			var n = e(t);
			if (!n.hasClass(this.markerClassName)) {
				return
			}
			n.removeClass(this.markerClassName);
			if (t.namespaceURI != this.svgNS) {
				n.empty()
			}
			e.removeData(t, r)
		},
		addExtension: function(e, t) {
			this._extensions.push([e, t])
		},
		isSVGElem: function(t) {
			return t.nodeType == 1 && t.namespaceURI == e.svg.svgNS
		}
	});
	e.extend(i.prototype, {
		...
		configure: function(t, n, r) {
			...
			if (r) {
				for (var i = t.attributes.length - 1; i >= 0; i--) {
					...
					if (!(s.nodeName == "onload" || s.nodeName == "version" || s.nodeName.substring(0, 5) == "xmlns")) {
						t.attributes.removeNamedItem(s.nodeName)
					}
				}
			}
			for (var o in n) {
				t.setAttribute(e.svg._attrNames[o] || o, n[o])
			}
			return this
		},
		getElementById: function(e) {
			return this._svg.ownerDocument.getElementById(e)
		},
		change: function(t, n) {
			if (t) {
				for (var r in n) {
					if (n[r] == null) {
						t.removeAttribute(e.svg._attrNames[r] || r)
					} else {
						t.setAttribute(e.svg._attrNames[r] || r, n[r])
					}
				}
			}
			return this
		},
		_args: function(t, n, r) {
			n.splice(0, 0, "parent");
			n.splice(n.length, 0, "settings");
			var i = {};
			var s = 0;
			if (t[0] != null && t[0].jquery) {
				t[0] = t[0][0]
			}
			if (t[0] != null && !(typeof t[0] == "object" && t[0].nodeName)) {
				i["parent"] = null;
				s = 1
			}
		...
		title: function(e, t, n) {
			...
			var i = this._makeNode(r.parent, "title", r.settings || {});
			i.appendChild(this._svg.ownerDocument.createTextNode(r.text));
			return i
		},
		describe: function(e, t, n) {
			var r = this._args(arguments, ["text"]);
			var i = this._makeNode(r.parent, "desc", r.settings || {});
			i.appendChild(this._svg.ownerDocument.createTextNode(r.text));
			return i
		},
		defs: function(t, n, r) {
			var i = this._args(arguments, ["id"], ["id"]);
			return this._makeNode(i.parent, "defs", e.extend(i.id ? {
				id: i.id
			} : {}, i.settings || {}))
		},
		symbol: function(t, n, r, i, s, o, u) {
			var a = this._args(arguments, ["id", "x1", "y1", "width", "height"]);
			return this._makeNode(a.parent, "symbol", e.extend({
				id: a.id,
				viewBox: a.x1 + " " + a.y1 + " " + a.width + " " + a.height
			}, a.settings || {}))
		},
		marker: function(t, n, r, i, s, o, u, a) {
			var f = this._args(arguments, ["id", "refX", "refY", "mWidth", "mHeight", "orient"], ["orient"]);
			return this._makeNode(f.parent, "marker", e.extend({
				id: f.id,
				refX: f.refX,
				refY: f.refY,
				markerWidth: f.mWidth,
				markerHeight: f.mHeight,
				orient: f.orient || "auto"
			}, f.settings || {}))
		},
		style: function(t, n, r) {
			var i = this._args(arguments, ["styles"]);
			var s = this._makeNode(i.parent, "style", e.extend({
				type: "text/css"
			}, i.settings || {}));
			s.appendChild(this._svg.ownerDocument.createTextNode(i.styles));
			if (e.browser.opera) {
				e("head").append('<style type="text/css">' + i.styles + "</style>")
			}
			return s
		},
		script: function(t, n, r, i) {
			var s = this._args(arguments, ["script", "type"], ["type"]);
			var o = this._makeNode(s.parent, "script", e.extend({
				type: s.type || "text/javascript"
			}, s.settings || {}));
			o.appendChild(this._svg.ownerDocument.createTextNode(s.script));
			if (!e.browser.mozilla) {
				e.globalEval(s.script)
			}
			return o
		},
		linearGradient: function(t, n, r, i, s, o, u, a) {
			var f = this._args(arguments, ["id", "stops", "x1", "y1", "x2", "y2"], ["x1"]);
			var l = e.extend({
				id: f.id
			}, f.x1 != null ? {
				x1: f.x1,
			...
			return this._gradient(f.parent, "linearGradient", e.extend(l, f.settings || {}), f.stops)
		},
		radialGradient: function(t, n, r, i, s, o, u, a, f) {
			...
			return this._gradient(l.parent, "radialGradient", e.extend(c, l.settings || {}), l.stops)
		},
		_gradient: function(t, n, r, i) {
			var s = this._makeNode(t, n, r);
			for (var o = 0; o < i.length; o++) {
				var u = i[o];
				this._makeNode(s, "stop", e.extend({
					offset: u[0],
					stopColor: u[1]
				}, u[2] != null ? {
					stopOpacity: u[2]
		...
		pattern: function(t, n, r, i, s, o, u, a, f, l, c) {
			var h = this._args(arguments, ["id", "x", "y", "width", "height", "vx", "vy", "vwidth", "vheight"], ["vx"]);
			var p = e.extend({
				id: h.id,
				x: h.x,
				y: h.y,
				...
				viewBox: h.vx + " " + h.vy + " " + h.vwidth + " " + h.vheight
			} : {});
			return this._makeNode(h.parent, "pattern", e.extend(p, h.settings || {}))
		},
		clipPath: function(t, n, r, i) {
			var s = this._args(arguments, ["id", "units"]);
			s.units = s.units || "userSpaceOnUse";
			return this._makeNode(s.parent, "clipPath", e.extend({
				id: s.id,
				clipPathUnits: s.units
			}, s.settings || {}))
		},
		mask: function(t, n, r, i, s, o, u) {
			var a = this._args(arguments, ["id", "x", "y", "width", "height"]);
			return this._makeNode(a.parent, "mask", e.extend({
				id: a.id,
				x: a.x,
				y: a.y,
				width: a.width,
		...
		svg: function(t, n, r, i, s, o, u, a, f, l) {
			...
			return this._makeNode(c.parent, "svg", e.extend(h, c.settings || {}))
		},
		group: function(t, n, r) {
			var i = this._args(arguments, ["id"], ["id"]);
			return this._makeNode(i.parent, "g", e.extend({
				id: i.id
			}, i.settings || {}))
		},
		use: function(t, n, r, i, s, o, u) {
			var a = this._args(arguments, ["x", "y", "width", "height", "ref"]);
			if (typeof a.x == "string") {
				a.ref = a.x;
				a.settings = a.y;
				a.x = a.y = a.width = a.height = null
			}
			var f = this._makeNode(a.parent, "use", e.extend({
				x: a.x,
				y: a.y,
				width: a.width,
				height: a.height
			}, a.settings || {}));
			f.setAttributeNS(e.svg.xlinkNS, "href", a.ref);
			return f
		},
		link: function(t, n, r) {
			var i = this._args(arguments, ["ref"]);
			var s = this._makeNode(i.parent, "a", i.settings);
			s.setAttributeNS(e.svg.xlinkNS, "href", i.ref);
			return s
		},
		image: function(t, n, r, i, s, o, u) {
			var a = this._args(arguments, ["x", "y", "width", "height", "ref"]);
			var f = this._makeNode(a.parent, "image", e.extend({
				x: a.x,
				y: a.y,
				width: a.width,
				height: a.height
		...
		path: function(t, n, r) {
			...
			return this._makeNode(i.parent, "path", e.extend({
				d: i.path.path ? i.path.path() : i.path
			}, i.settings || {}))
		},
		rect: function(t, n, r, i, s, o, u, a) {
			var f = this._args(arguments, ["x", "y", "width", "height", "rx", "ry"], ["rx"]);
			return this._makeNode(f.parent, "rect", e.extend({
				x: f.x,
				y: f.y,
				width: f.width,
				height: f.height
		...
		circle: function(t, n, r, i, s) {
			var o = this._args(arguments, ["cx", "cy", "r"]);
			return this._makeNode(o.parent, "circle", e.extend({
				cx: o.cx,
				cy: o.cy,
				r: o.r
			}, o.settings || {}))
		},
		ellipse: function(t, n, r, i, s, o) {
			var u = this._args(arguments, ["cx", "cy", "rx", "ry"]);
			return this._makeNode(u.parent, "ellipse", e.extend({
				cx: u.cx,
				cy: u.cy,
				rx: u.rx,
				ry: u.ry
		...
		line: function(t, n, r, i, s, o) {
			var u = this._args(arguments, ["x1", "y1", "x2", "y2"]);
			return this._makeNode(u.parent, "line", e.extend({
				x1: u.x1,
				y1: u.y1,
				x2: u.x2,
				y2: u.y2
		...
		_poly: function(t, n, r, i) {
			var s = "";
			for (var o = 0; o < r.length; o++) {
				s += r[o].join() + " "
			}
			return this._makeNode(t, n, e.extend({
				points: e.trim(s)
			}, i || {}))
		},
		text: function(t, n, r, i, s) {
			var o = this._args(arguments, ["x", "y", "value"]);
			if (typeof o.x == "string" && arguments.length < 4) {
				o.value = o.x;
				o.settings = o.y;
				o.x = o.y = null
			}
			return this._text(o.parent, "text", o.value, e.extend({
				x: o.x && u(o.x) ? o.x.join(" ") : o.x,
				y: o.y && u(o.y) ? o.y.join(" ") : o.y
			}, o.settings || {}))
		},
		textpath: function(t, n, r, i) {
			var s = this._args(arguments, ["path", "value"]);
			var o = this._text(s.parent, "textPath", s.value, s.settings || {});
			o.setAttributeNS(e.svg.xlinkNS, "href", s.path);
			return o
		},
		_text: function(t, n, r, i) {
			var s = this._makeNode(t, n, i);
			if (typeof r == "string") {
				s.appendChild(s.ownerDocument.createTextNode(r))
			} else {
				for (var o = 0; o < r._parts.length; o++) {
					var u = r._parts[o];
					if (u[0] == "tspan") {
						var a = this._makeNode(s, u[0], u[2]);
						a.appendChild(s.ownerDocument.createTextNode(u[1]));
						s.appendChild(a)
					} else if (u[0] == "tref") {
						var a = this._makeNode(s, u[0], u[2]);
						a.setAttributeNS(e.svg.xlinkNS, "href", u[1]);
						s.appendChild(a)
					} else if (u[0] == "textpath") {
						var f = e.extend({}, u[2]);
						f.href = null;
						var a = this._makeNode(s, u[0], f);
						a.setAttributeNS(e.svg.xlinkNS, "href", u[2].href);
						a.appendChild(s.ownerDocument.createTextNode(u[1]));
						s.appendChild(a)
					} else {
						s.appendChild(s.ownerDocument.createTextNode(u[1]))
					}
				}
			}
			return s
		...
		_makeNode: function(t, n, r) {
			t = t || this._svg;
			var i = this._svg.ownerDocument.createElementNS(e.svg.svgNS, n);
			for (var n in r) {
				var s = r[n];
				if (s != null && s != null && (typeof s != "string" || s != "")) {
					i.setAttribute(e.svg._attrNames[n] || n, s)
				}
			}
			t.appendChild(i);
			return i
		...
		add: function(t, n) {
			var r = this._args(arguments.length == 1 ? [null, t] : arguments, ["node"]);
			var i = this;
			r.parent = r.parent || this._svg;
			r.node = r.node.jquery ? r.node : e(r.node);
			try {
				if (e.svg._renesis) {
					throw "Force traversal"
				}
				r.parent.appendChild(r.node.cloneNode(true))
			} catch (s) {
				r.node.each(function() {
					var e = i._cloneAsSVG(this);
					if (e) {
		...
		clone: function(t, n) {
			var r = this;
			var i = this._args(arguments.length == 1 ? [null, t] : arguments, ["node"]);
			i.parent = i.parent || this._svg;
			i.node = i.node.jquery ? i.node : e(i.node);
			var s = [];
			i.node.each(function() {
				var e = r._cloneAsSVG(this);
				if (e) {
					e.id = "";
					i.parent.appendChild(e);
					s.push(e)
				}
			});
			return s
		},
		_cloneAsSVG: function(t) {
			var n = null;
			if (t.nodeType == 1) {
				n = this._svg.ownerDocument.createElementNS(e.svg.svgNS, this._checkName(t.nodeName));
				for (var r = 0; r < t.attributes.length; r++) {
					var i = t.attributes.item(r);
					if (i.nodeName != "xmlns" && i.nodeValue) {
						if (i.prefix == "xlink") {
							n.setAttributeNS(e.svg.xlinkNS, i.localName || i.baseName, i.nodeValue)
						} else {
							n.setAttribute(this._checkName(i.nodeName), i.nodeValue)
						}
					}
				}
				for (var r = 0; r < t.childNodes.length; r++) {
					var s = this._cloneAsSVG(t.childNodes[r]);
					if (s) {
						n.appendChild(s)
					}
				}
			} else if (t.nodeType == 3) {
				if (e.trim(t.nodeValue)) {
					n = this._svg.ownerDocument.createTextNode(t.nodeValue)
				}
			} else if (t.nodeType == 4) {
				if (e.trim(t.nodeValue)) {
					try {
						n = this._svg.ownerDocument.createCDATASection(t.nodeValue)
					} catch (o) {
						n = this._svg.ownerDocument.createTextNode(t.nodeValue.replace(/&/g, "&").replace(/</g, "&lt;").replace(/>/g, "&gt;"))
					}
				}
			}
			return n
		...
		_checkName: function(e) {
			e = e.substring(0, 1) >= "A" && e.substring(0, 1) <= "Z" ? e.toLowerCase() : e;
			return e.substring(0, 4) == "svg:" ? e.substring(4) : e
		},
		load: function(t, n) {
			n = typeof n == "boolean" ? {
				addTo: n
				...
				parent: n
			} : typeof n == "object" && n.nodeName ? {
				parent: n
			} : typeof n == "object" && n.jquery ? {
				parent: n
			} : n || {};
			if (!n.parent && !n.addTo) {
				this.clear(false)
			...
			var i = this;
			var s = function(t) {
				t = e.svg.local.errorLoadingText + ": " + t;
				if (n.onLoad) {
					n.onLoad.apply(i._container || i._svg, [i, t])
				} else {
					i.text(null, 10, 20, t)
				}
			};
			...
			var u = function(t) {
				...
				if (t.documentElement.nodeName != "svg") {
					var o = t.getElementsByTagName("parsererror");
					var u = o.length ? o[0].getElementsByTagName("div") : [];
					s(!o.length ? "???" : (u.length ? u[0] : o[0]).firstChild.nodeValue);
					return
				}
				var a = n.parent ? e(n.parent)[0] : i._svg;
				var f = {};
				for (var l = 0; l < t.documentElement.attributes.length; l++) {
					var c = t.documentElement.attributes.item(l);
					if (!(c.nodeName == "version" || c.nodeName.substring(0, 5) == "xmlns")) {
						f[c.nodeName] = c.nodeValue
					}
				}
				i.configure(a, f, !n.parent);
				var h = t.documentElement.childNodes;
				for (var l = 0; l < h.length; l++) {
					try {
						if (e.svg._renesis) {
							throw "Force traversal"
						}
						a.appendChild(i._svg.ownerDocument.importNode(h[l], true));
						if (h[l].nodeName == "script") {
							e.globalEval(h[l].textContent)
						}
					} catch (p) {
						i.add(a, h[l])
					}
				...
				if (n.onLoad) {
					n.onLoad.apply(i._container || i._svg, [i])
				}
			};
			if (t.match("<svg")) {
				u(e.browser.msie ? o(t) : (new DOMParser).parseFromString(t, "text/xml"))
			} else {
				e.ajax({
					url: t,
					dataType: e.browser.msie ? "text" : "xml",
					success: function(t) {
						u(e.browser.msie ? o(t) : t)
					},
		...
		toSVG: function(e) {
			e = e || this._svg;
			return typeof XMLSerializer == "undefined" ? this._toSVG(e) : (new XMLSerializer).serializeToString(e)
		},
		_toSVG: function(t) {
			var n = "";
			if (!t) {
			...
			if (t.nodeType == 3) {
				...
				if (t.attributes) {
					for (var r = 0; r < t.attributes.length; r++) {
						var i = t.attributes.item(r);
						if (!(e.trim(i.nodeValue) == "" || i.nodeValue.match(/^\[object/) || i.nodeValue.match(/^function/))) {
							n += " " + (i.namespaceURI == e.svg.xlinkNS ? "xlink:" : "") + i.nodeName + '="' + i.nodeValue + '"'
						}
					}
				}
				if (t.firstChild) {
	...
	e.extend(s.prototype, {
		...
		move: function(e, t, n) {
			n = u(e) ? t : n;
			return this._coords(n ? "m" : "M", e, t)
		},
		line: function(e, t, n) {
			n = u(e) ? t : n;
			return this._coords(n ? "l" : "L", e, t)
		},
		horiz: function(e, t) {
			this._path += (t ? "h" : "H") + (u(e) ? e.join(" ") : e);
			return this
		},
		vert: function(e, t) {
			this._path += (t ? "v" : "V") + (u(e) ? e.join(" ") : e);
			return this
		},
		curveC: function(e, t, n, r, i, s, o) {
			o = u(e) ? t : o;
			return this._coords(o ? "c" : "C", e, t, n, r, i, s)
		},
		smoothC: function(e, t, n, r, i) {
			i = u(e) ? t : i;
			return this._coords(i ? "s" : "S", e, t, n, r)
		},
		curveQ: function(e, t, n, r, i) {
			i = u(e) ? t : i;
			return this._coords(i ? "q" : "Q", e, t, n, r)
		},
		smoothQ: function(e, t, n) {
			n = u(e) ? t : n;
			return this._coords(n ? "t" : "T", e, t)
		},
		_coords: function(e, t, n, r, i, s, o) {
			if (u(t)) {
				for (var a = 0; a < t.length; a++) {
					var f = t[a];
					this._path += (a == 0 ? e : " ") + f[0] + "," + f[1] + (f.length < 4 ? "" : " " + f[2] + "," + f[3] + (f.length < 6 ? "" : " " + f[4] + "," + f[5]))
				}
			} else {
				this._path += e + t + "," + n + (r == null ? "" : " " + r + "," + i + (s == null ? "" : " " + s + "," + o))
			}
			return this
		},
		arc: function(e, t, n, r, i, s, o, a) {
			a = u(e) ? t : a;
			this._path += a ? "a" : "A";
			if (u(e)) {
				for (var f = 0; f < e.length; f++) {
					var l = e[f];
					this._path += (f == 0 ? "" : " ") + l[0] + "," + l[1] + " " + l[2] + " " + (l[3] ? "1" : "0") + "," + (l[4] ? "1" : "0") + " " + l[5] + "," + l[6]
				}
			} else {
				this._path += e + "," + t + " " + n + " " + (r ? "1" : "0") + "," + (i ? "1" : "0") + " " + s + "," + o
			}
			return this
		},
		close: function() {
	...
	s.prototype.moveTo = s.prototype.move;
	s.prototype.lineTo = s.prototype.line;
	s.prototype.horizTo = s.prototype.horiz;
	s.prototype.vertTo = s.prototype.vert;
	s.prototype.curveCTo = s.prototype.curveC;
	s.prototype.smoothCTo = s.prototype.smoothC;
	s.prototype.curveQTo = s.prototype.curveQ;
	s.prototype.smoothQTo = s.prototype.smoothQ;
	s.prototype.arcTo = s.prototype.arc;
	e.extend(o.prototype, {
		...
		string: function(e) {
			this._parts[this._parts.length] = ["text", e];
			return this
		},
		span: function(e, t) {
			this._parts[this._parts.length] = ["tspan", e, t];
			return this
		},
		ref: function(e, t) {
			this._parts[this._parts.length] = ["tref", e, t];
			return this
		},
		path: function(t, n, r) {
			this._parts[this._parts.length] = ["textpath", n, e.extend({
				href: t
			}, r || {})];
			return this
		}
	...
	e.fn.svg = function(t) {
		...
		if (typeof t == "string" && t == "get") {
			return e.svg["_" + t + "SVG"].apply(e.svg, [this[0]].concat(n))
		}
		return this.each(function() {
			if (typeof t == "string") {
				e.svg["_" + t + "SVG"].apply(e.svg, [this].concat(n))
			} else {
				e.svg._attachSVG(this, t || {})
			}
		})
	};
	e.svg = new t
...
(function(e) {
	function t(t) {
		for (var n = 0; n < t.length; n++) {
			if (t[n].nodeType == 1 && t[n].namespaceURI == e.svg.svgNS) {
				return true
			}
		}
		return false
	}
	e.fn.addClass = function(t) {
		return function(n) {
			n = n || "";
			return this.each(function() {
				if (e.svg.isSVGElem(this)) {
					...
					e.each(n.split(/\s+/), function(t, n) {
						var i = r.className ? r.className.baseVal : r.getAttribute("class");
						if (e.inArray(n, i.split(/\s+/)) == -1) {
							i += (i ? " " : "") + n;
							r.className ? r.className.baseVal = i : r.setAttribute("class", i)
						}
					})
				} else {
					t.apply(e(this), [n])
		...
		return function(n) {
			...
			return this.each(function() {
				if (e.svg.isSVGElem(this)) {
					...
					e.each(n.split(/\s+/), function(t, n) {
						var i = r.className ? r.className.baseVal : r.getAttribute("class");
						i = e.grep(i.split(/\s+/), function(e, t) {
							return e != n
						}).join(" ");
						r.className ? r.className.baseVal = i : r.setAttribute("class", i)
					})
	...
	e.fn.hasClass = function(t) {
		return function(n) {
			n = n || "";
			var r = false;
			this.each(function() {
				if (e.svg.isSVGElem(this)) {
					var i = (this.className ? this.className.baseVal : this.getAttribute("class")).split(/\s+/);
					r = e.inArray(n, i) > -1
				} else {
					r = t.apply(e(this), [n])
				}
	...
	e.fn.attr = function(t) {
		return function(n, r, i) {
			if (typeof n === "string" && r === undefined) {
				var s = t.apply(this, [n]);
				if (s && s.baseVal && s.baseVal.numberOfItems != null) {
					r = "";
					s = s.baseVal;
					if (n == "transform") {
						for (var o = 0; o < s.numberOfItems; o++) {
							var u = s.getItem(o);
							switch (u.type) {
								case 1:
									r += " matrix(" + u.matrix.a + "," + u.matrix.b + "," + u.matrix.c + "," + u.matrix.d + "," + u.matrix.e + "," + u.matrix.f + ")";
									break;
								case 2:
									r += " translate(" + u.matrix.e + "," + u.matrix.f + ")";
									break;
								case 3:
									r += " scale(" + u.matrix.a + "," + u.matrix.d + ")";
									break;
								case 4:
									r += " rotate(" + u.angle + ")";
									break;
						...
						s = s.getItem(0).valueAsString
					}
				}
				return s && s.baseVal ? s.baseVal.valueAsString : s
			}
			var a = n;
			if (typeof n === "string") {
				a = {};
			...
			return this.each(function() {
				if (e.svg.isSVGElem(this)) {
					for (var s in a) {
						var o = e.isFunction(a[s]) ? a[s]() : a[s];
						i ? this.style[s] = o : this.setAttribute(s, o)
					}
				} else {
					t.apply(e(this), [n, r, i])
				}
			})
		}
	}(e.fn.attr);
	e.fn.removeAttr = function(t) {
		return function(n) {
			return this.each(function() {
				if (e.svg.isSVGElem(this)) {
					this[n] && this[n].baseVal ? this[n].baseVal.value = "" : this.setAttribute(n, "")
				} else {
					t.apply(e(this), [n])
				}
			})
	...
	if (e.cssProps) {
		e.css = function(t) {
			return function(n, r, i) {
				var s = r.match(/^svg.*/) ? e(n).attr(e.cssProps[r] || r) : "";
				return s || t(n, r, i)
			}
		}(e.css)
	}
	e.expr.relative["+"] = function(e) {
		return function(n, r, i) {
			e(n, r, i || t(n))
		}
	}(e.expr.relative["+"]);
	...
	e.expr.find.ID = function(t) {
		return function(n, r, i) {
			return e.svg.isSVGElem(r) ? [r.ownerDocument.getElementById(n[1])] : t(n, r, i)
		}
	}(e.expr.find.ID);
	var n = document.createElement("div");
	n.appendChild(document.createComment(""));
	if (n.getElementsByTagName("*").length > 0) {
		e.expr.find.TAG = function(e, t) {
			var n = t.getElementsByTagName(e[1]);
			if (e[1] === "*") {
				var r = [];
				for (var i = 0; n[i] || n.item(i); i++) {
					if ((n[i] || n.item(i)).nodeType === 1) {
						r.push(n[i] || n.item(i))
					}
				}
				n = r
	...
	e.expr.preFilter.CLASS = function(t, n, r, i, s, o) {
		t = " " + t[1].replace(/\\/g, "") + " ";
		if (o) {
			return t
		}
		for (var u = 0, a = {}; a != null; u++) {
			a = n[u];
			if (!a) {
				try {
					a = n.item(u)
			...
			if (a) {
				var l = !e.svg.isSVGElem(a) ? a.className : (a.className ? a.className.baseVal : "") || a.getAttribute("class");
				if (s ^ (l && (" " + l + " ").indexOf(t) > -1)) {
					if (!r) i.push(a)
				} else if (r) {
					n[u] = false
				}
	...
	e.expr.filter.CLASS = function(t, n) {
		var r = !e.svg.isSVGElem(t) ? t.className : t.className ? t.className.baseVal : t.getAttribute("class");
		return (" " + r + " ").indexOf(n) > -1
	};
	e.expr.filter.ATTR = function(t) {
		return function(n, r) {
			var i = null;
			if (e.svg.isSVGElem(n)) {
				i = r[1];
				e.expr.attrHandle[i] = function(e) {
...
(function(e) {
	...
	e.widget("ui.droppable", {
		...
		var i, s, o = (e.positionAbs || e.position.absolute).left,
			...
			l = n.offset.left,
			c = n.offset.top,
			h = l + n.proportions().width,
			p = c + n.proportions().height;
		switch (r) {
			case "fit":
				return o >= l && h >= a && u >= c && p >= f;
			case "intersect":
				return o + e.helperProportions.width / 2 > l && h > a - e.helperProportions.width / 2 && u + e.helperProportions.height / 2 > c && p > f - e.helperProportions.height / 2;
			case "pointer":
				return i = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left, s = (e.positionAbs || e.position.absolute).top + (e.clickOffset || e.offset.click).top, t(s, c, n.proportions().height) && t(i, l, n.proportions().width);
			case "touch":
				return (u >= c && p >= u || f >= c && p >= f || c > u && f > p) && (o >= l && h >= o || a >= l && h >= a || l > o && a > h);
			default:
				return !1
		}
	}, e.ui.ddmanager = {
...
(function(e) {
	...
	n.height = n.paddingTop = n.paddingBottom = n.borderTopWidth = n.borderBottomWidth = "hide", r.height = r.paddingTop = r.paddingBottom = r.borderTopWidth = r.borderBottomWidth = "show", e.widget("ui.accordion", {
		...
		_animate: function(e, t, s) {
			...
			return "number" == typeof d && (f = d), "string" == typeof d && (u = d), u = u || d.easing || p.easing, f = f || d.duration || p.duration, t.length ? e.length ? (o = e.show().outerHeight(), t.animate(n, {
				duration: f,
				easing: u,
				step: function(e, t) {
					t.now = Math.round(e)
				...
				complete: v,
				step: function(e, n) {
					n.now = Math.round(e), "height" !== n.prop ? c += n.now : "content" !== l.options.heightStyle && (n.now = Math.round(o - t.outerHeight() - c), c = 0)
				}
			}), undefined) : t.animate(n, f, u, v) : e.animate(r, f, u, v)
		},
...
(function(e) {
	...
	e.widget("ui.button", {
		...
		_destroy: function() {
			this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(n + " ui-state-active " + r).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), this.hasTitle || this.buttonElement.removeAttr("title")
		},
		_setOption: function(e, t) {
		...
		refresh: function() {
			...
			t !== this.options.disabled && this._setOption("disabled", t), "radio" === this.type ? s(this.element[0]).each(function() {
		...
		_create: function() {
			this.activeMenu = this.element, this.mouseHandled = !1, this.element.uniqueId().addClass("ui-menu ui-widget ui-widget-content ui-corner-all").toggleClass("ui-menu-icons", !!this.element.find(".ui-icon").length).attr({
				...
				"click .ui-menu-item:has(a)": function(n) {
					...
					!this.mouseHandled && r.not(".ui-state-disabled").length && (this.select(n), n.isPropagationStopped() || (this.mouseHandled = !0), r.has(".ui-menu").length ? this.expand(n) : !this.element.is(":focus") && e(this.document[0].activeElement).closest(".ui-menu").length && (this.element.trigger("focus", [!0]), this.active && 1 === this.active.parents(".ui-menu").length && clearTimeout(this.timer)))
				},
...
(function(e, t) {
	...
	function r(e) {
		return e = e.cloneNode(!1), e.hash.length > 1 && decodeURIComponent(e.href.replace(s, "")) === decodeURIComponent(location.href.replace(s, ""))
	}
	var i = 0,
		s = /#.*$/;
	e.widget("ui.tabs", {
